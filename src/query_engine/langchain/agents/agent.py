...
class Agent(BaseSingleActionAgent):
    ...
    def plan(
        ...
        **kwargs: Any,
        ...
        print(f"Agent, plan, full_inputs={full_inputs}, full_output={full_output}")
...
class ExceptionTool(BaseTool):
    ...
    def _run(
        ...
        print(f"ExceptionTool, _run, query={query}")
        return query
...
class AgentExecutor(Chain):
    ...
    def _take_next_step(
        ...
        try:
            ...
            traceback.print_exc()
            print(f"AgentExecutor, _take_next_step, OutputParserException, e={e}")
        ...
        for agent_action in actions:
            ...
            if agent_action.tool in name_to_tool_map:
                ...
                tool_run_kwargs = self.agent.tool_run_logging_kwargs()
                print(f"AgentExecutor, actions, return_direct={return_direct}")
